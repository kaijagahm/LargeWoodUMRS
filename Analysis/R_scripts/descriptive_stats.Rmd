...
# Reassign pools
old_upperlower <- old_upperlower %>%
  mutate(pool = case_when(pool == "13" ~ "P13",
                          pool == "26" ~ "P26",
                          pool == "4" ~ "P04",
                          pool == "8" ~ "P08",
                          pool == "LG" ~ "LAG",
...
# also went back into the old data cleaning code and saw that in fact, we did want to exclude the ones that are NA for a bunch of these environmental variables. I'll go back and do that now. 
