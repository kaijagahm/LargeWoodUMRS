...
sites_p4p8p13 <- read.csv("../data/DataSets_7_7/AttributeTables/sites_p4p8p13.txt") 
  # reprojected data
rivmi <- read.table("../data/p4p8p13_rivmile.txt", sep = ",", header = T) 
  # river mile data
...
### Terrestrial areas
```{r}
# `Field 1` in this dataset corresponds to the FID in the terrestrial areas dataset. 
...
# Distance to nearest terrestrial region
